  ...
  return (
    <>
      <div className='wrapper relative'>
        ...
        <section className='md:flex mt-32 pt-32'>
          ...
          <div className=' w-3/5 mr-12 font-[libre]'>
            ...
            <button className='bg-primary mt-16 text-white hover:bg-primary hover:border-transparent py-4 px-16 transition-all  duration-500 ease-in' >Learn More</button>
          </div>
        </section>
      </div>
    </>
